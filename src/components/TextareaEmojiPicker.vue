...
<template>
  <button @click="toggleEmojiPicker">
    <v-icon class="Icon">insert_emoticon</v-icon>
  </button>
...
<!-- <template>
  <div @click="toggleEmojiPicker" class="textarea-emoji-picker"> -->
...
<!-- <template>
    ...
    <v-footer>
        ...
        <div class="floating-div">
            <picker v-if="emoStatus" set="emojione" @select="oninput" title="Pick you emoji "/>
        ...
        <v-flex>
            ...
            <span class="small font-italic">{{m}}</span>
